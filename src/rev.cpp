 ...
 */
const char _openttd_revision[] = "1.6.0";
 ...
 */
const uint32 _openttd_newgrf_version = 1 << 28 | 6 << 24 | 0 << 20 | 1 << 19 | (27532 & ((1 << 19) - 1));

#ifdef __MORPHOS__
/**
 * Variable used by MorphOS to show the version.
 */
extern const char morphos_versions_tag[] = "$VER: OpenTTD 1.6.0 (02.04.16) OpenTTD Team [MorphOS, PowerPC]";
#endif
