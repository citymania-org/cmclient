 ...
 */
const char _openttd_revision[] = "1.4.0-RC1";
 ...
 */
const uint32 _openttd_newgrf_version = 1 << 28 | 4 << 24 | 0 << 20 | 0 << 19 | (26415 & ((1 << 19) - 1));

#ifdef __MORPHOS__
/**
 * Variable used by MorphOS to show the version.
 */
extern const char morphos_versions_tag[] = "$VER: OpenTTD 1.4.0-RC1 (25.03.14) OpenTTD Team [MorphOS, PowerPC]";
#endif
